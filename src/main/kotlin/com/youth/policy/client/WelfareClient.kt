...
class WelfareClient(
    ...
    @Value("\${welfare.api.list.url}") private val listApiUrl: String,
    @Value("\${welfare.api.detail.url}") private val detailApiUrl: String,
    @Value("\${welfare.api.key}") private val serviceKey: String
) {
